class Recipe_EA_Food_Plate_Vegetables_Soup extends Recipe_EA_Base // 🔴
{	
    ...
    {   
        ...
        m_Name = "[Cuisiner] Soupe de légumes"; // 🔴
        ...
        //Ingrédients #2
        InsertIngredient(1,"EA_Food_Plate_Water"); // 🔴
        ...
        AddResult("EA_Food_Plate_Vegetables_Soup"); // 🔴
