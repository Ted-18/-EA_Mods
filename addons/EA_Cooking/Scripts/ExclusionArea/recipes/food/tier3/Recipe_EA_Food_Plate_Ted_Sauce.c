class Recipe_EA_Food_Plate_Ted_Sauce extends Recipe_EA_Base // 🔴
{	
    ...
    {   
        ...
        m_Name = "[Cuisiner] Sauce bolognaise de Ted"; // 🔴
        ...
        //Ingrédients #2
        InsertIngredient(1,"EA_Food_Plate_Bolognese_Sauce"); // 🔴
        ...
        AddResult("EA_Food_Plate_Ted_Sauce"); // 🔴
