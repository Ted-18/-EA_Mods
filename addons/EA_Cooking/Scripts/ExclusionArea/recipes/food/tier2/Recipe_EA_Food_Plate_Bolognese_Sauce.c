class Recipe_EA_Food_Plate_Bolognese_Sauce extends Recipe_EA_Base // 🔴
{	
    ...
    {   
        ...
        m_Name = "[Cuisiner] Sauce bolognaise"; // 🔴
        ...
        //Ingrédients #2
        InsertIngredient(1,"EA_Food_Plate_Tomato_Sauce"); // 🔴
        ...
        AddResult("EA_Food_Plate_Bolognese_Sauce"); // 🔴
