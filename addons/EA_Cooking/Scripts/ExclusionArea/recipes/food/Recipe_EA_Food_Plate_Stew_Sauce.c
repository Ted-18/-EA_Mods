class Recipe_EA_Food_Plate_Stew_Sauce extends Recipe_EA_Base // 🔴
{	
    ...
    {   
        ...
        m_Name = "[Cuisiner] Sauce à ragoût"; // 🔴
        ...
        AddResult("EA_Food_Plate_Stew_Sauce"); // 🔴
