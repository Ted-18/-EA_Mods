class Recipe_EFI_Sausage_Curry extends RecipeBase
{	
    ...
    {   
        ...
        m_Name = "[Cuisiner] Saussice au curry";
        ...
        //Ingrédients #2
        InsertIngredient(1,"PigSteakMeat"); // TODO
        InsertIngredient(1,"SheepSteakMeat"); // TODO
        InsertIngredient(1,"BoarSteakMeat"); // TODO
	...
	{
		Debug.Log("Recipe_EFI_Sausage_Curry Do method called","recipes");
	}
};